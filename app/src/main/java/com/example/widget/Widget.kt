...
class Widget : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Button Snackbar
        binding.btnSnakbar.setOnClickListener {
        ...
        binding.btnAlert.setOnClickListener {
            AlertDialog.Builder(this).apply {
                ...
                setPositiveButton("OK"){dialog, _->
                    Toast.makeText(applicationContext,"Anda kilik OK",Toast.LENGTH_SHORT).show()
                    dialog.dismiss()
                }
                setNegativeButton("Back"){dialog, _->
                    Toast.makeText(applicationContext,"Anda kilik BACK",Toast.LENGTH_SHORT).show()
                    dialog.dismiss()
                }
            }.show()
        }
